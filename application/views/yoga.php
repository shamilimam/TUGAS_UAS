         ...
         <div class="container-fluid">
            <div class="row d_flex">
               <div class="col-md-5 padding_left0">
                  <div class="yoga_img">
                     <figure><img src="<?php echo base_url() . "assets/images/yoga_mo1.png"?>" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-6 offset-md-1">
                  <div class="titlepage">
                     <h2 class="padd_top30">YOGA</h2>
                     <p>Kebanyakan orang mengira bahwa gerakan yoga hanya sekadar duduk bersila dan memejamkan mata, padahal ternyata gerakan-gerakannya tidak semata-mata itu saja lho! Setiap jenis memiliki gerakannya masing-masing yang tentu saja harus disesuaikan dengan kemampuan ya!!.</p>
                     <a class="read_more ye_b5n " href="<?php echo base_url() . "assets/file/YOGASANA.pdf" ?>"> Read More</a>
                  </div>
               </div>
            </div>
         </div>
