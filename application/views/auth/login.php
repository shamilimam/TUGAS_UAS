...
<head>
    ...
    <title>Login Momsky parenting</title>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-7 mx-auto">
                ...
                <div class="card o-hidden bg-gradient-transparant border-0 shadow-lg my-5 col-lg-10 mx-auto">
                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-6">LOGIN</h1>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="auth/forgot">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
