            ...
            <div class="row">
               <div class="col-md-6 offset-md-3">
                  <div class="titlepage">
                     ...
                     <span>apa sih yoga itu? Bagaimana sejarah dari yoga hingga masih bertahan di zaman modern ini? Apa saja manfaat yang didapatkan dari melakukan olahraga yoga?</span>
                  </div>
               </div>
               <div class="col-md-12">
                  <div class="about_img">
                     <figure><img src="<?php echo base_url() . "assets/images/yoga3.jpg"?>" alt="#"/></figure>
                     <a class="read_more yoga_btn" href="<?php echo base_url() . "assets/file/YOGASANA.pdf" ?>"> Read More</a>
                  </div>
               </div>
            </div>
         </div>
